...
import torch
from models.unet_ccsdg import UNetCCSDG
def get_parser():
...
if __name__ == "__main__":
    ...
    eval_mode = True
    show_config = False
    model = UNetCCSDG(resnet='resnet50',num_classes=5)
    ...
    out_prediction_list, dsc_table, error_dict, domain_names = prediction_wrapper(model, 0.1, test_loader, 0, label_name, save_prediction=True)
